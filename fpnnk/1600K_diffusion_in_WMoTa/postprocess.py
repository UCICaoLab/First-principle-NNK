...
dump_file_name = "MoTaW.dump"
res_dir = "res_dir/"
nnk_log_file_name = "res_dir/nnk.log"
...
nnk.process_module.reconstruct_unwrap_vacancy_configs(neuron_map, dims, nnk_log, interval, dims, scale, res_dir)
...
print("Postprocessing Completed! Generating vacancy configuration file saved in path: results/res_dir/vacancy_configs_unwrap.dump.")
